...
public class CODRISCard {

     private String causeA;
     private String iCDCodeA;
     private Integer intervalTimeA;
     private Integer intervalUnitCodeA;
     private String causeB;
     private String iCDCodeB;
     private Integer intervalTimeB;
     private Integer intervalUnitCodeB;
     private String causeC;
     private String iCDCodeC;
     private Integer intervalTimeC;
     private Integer intervalUnitCodeC;
     private String causeD;
     private String iCDCodeD;
     private Integer intervalTimeD;
     private Integer intervalUnitCodeD;
     private String causeOther;
     private String iCDCodeOther;
     private String basicCause;
     private String basicICDCode;
     private Integer diagnosticUnitCode;
     private Integer diagnosticBasisCode;
    ...
    public Integer getIntervalTimeA() {
        return intervalTimeA;
    }

    public void setIntervalTimeA(Integer intervalTimeA) {
        this.intervalTimeA = intervalTimeA;
    }

    public Integer getIntervalUnitCodeA() {
        return intervalUnitCodeA;
    }

    public void setIntervalUnitCodeA(Integer intervalUnitCodeA) {
    ...
    public Integer getIntervalTimeB() {
        return intervalTimeB;
    }

    public void setIntervalTimeB(Integer intervalTimeB) {
        this.intervalTimeB = intervalTimeB;
    }

    public Integer getIntervalUnitCodeB() {
        return intervalUnitCodeB;
    }

    public void setIntervalUnitCodeB(Integer intervalUnitCodeB) {
    ...
    public Integer getIntervalTimeC() {
        return intervalTimeC;
    }

    public void setIntervalTimeC(Integer intervalTimeC) {
        this.intervalTimeC = intervalTimeC;
    }

    public Integer getIntervalUnitCodeC() {
        return intervalUnitCodeC;
    }

    public void setIntervalUnitCodeC(Integer intervalUnitCodeC) {
    ...
    public Integer getIntervalTimeD() {
        return intervalTimeD;
    }

    public void setIntervalTimeD(Integer intervalTimeD) {
        this.intervalTimeD = intervalTimeD;
    }

    public Integer getIntervalUnitCodeD() {
        return intervalUnitCodeD;
    }

    public void setIntervalUnitCodeD(Integer intervalUnitCodeD) {
    ...
    public Integer getDiagnosticUnitCode() {
        return diagnosticUnitCode;
    }

    public void setDiagnosticUnitCode(Integer diagnosticUnitCode) {
        this.diagnosticUnitCode = diagnosticUnitCode;
    }

    public Integer getDiagnosticBasisCode() {
        return diagnosticBasisCode;
    }

    public void setDiagnosticBasisCode(Integer diagnosticBasisCode) {
    ...
    public Integer getCorrectionState() {
        return correctionState;
    }

    public void setCorrectionState(Integer correctionState) {
    ...
    public Integer getWomanTypeCode() {
        return womanTypeCode;
    }

    public void setWomanTypeCode(Integer womanTypeCode) {
