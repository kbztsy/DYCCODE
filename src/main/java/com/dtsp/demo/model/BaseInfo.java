...
public class BaseInfo {
            ...
            private Integer iDR_OccupationCode;
            private Integer nCD_OccupationCode;
            private Integer cODRIS_OccupationCode;
            ...
            private Integer livingAddressAttributionCode;
            private String livingAddressAttributionName;
            private Integer livingAddressCode;
            ...
            private Date cardFillingTime;
            private Integer domicileAddressCode;
            private String domicileAddressName;
            private String domicileAdrressDetails;
            private Integer domicileAddressAttributionCode;
            ...
            private Integer lifeTimeZoneCode;
            private Integer lifeTimeVillageCode;
            private Integer lifeTimeAddrTypeCode;
            private Integer registerVillageCode;
            private Integer deathPlaceCode;
            private Integer diagnosisTypeCode;
    ...
    public Integer getiDR_OccupationCode() {
        return iDR_OccupationCode;
    }

    public void setiDR_OccupationCode(Integer iDR_OccupationCode) {
        this.iDR_OccupationCode = iDR_OccupationCode;
    }

    public Integer getnCD_OccupationCode() {
        return nCD_OccupationCode;
    }

    public void setnCD_OccupationCode(Integer nCD_OccupationCode) {
        this.nCD_OccupationCode = nCD_OccupationCode;
    }

    public Integer getcODRIS_OccupationCode() {
        return cODRIS_OccupationCode;
    }

    public void setcODRIS_OccupationCode(Integer cODRIS_OccupationCode) {
        this.cODRIS_OccupationCode = cODRIS_OccupationCode;
    }
    ...
    public Integer getLivingAddressAttributionCode() {
        return livingAddressAttributionCode;
    }

    public void setLivingAddressAttributionCode(Integer livingAddressAttributionCode) {
    ...
    public Integer getLivingAddressCode() {
        return livingAddressCode;
    }

    public void setLivingAddressCode(Integer livingAddressCode) {
    ...
    public Date getCardFillingTime() {
        return cardFillingTime;
    }

    public void setCardFillingTime(Date cardFillingTime) {
        this.cardFillingTime = cardFillingTime;
    }

    public Integer getDomicileAddressCode() {
        return domicileAddressCode;
    }

    public void setDomicileAddressCode(Integer domicileAddressCode) {
    ...
    public Integer getDomicileAddressAttributionCode() {
        return domicileAddressAttributionCode;
    }

    public void setDomicileAddressAttributionCode(Integer domicileAddressAttributionCode) {
    ...
    public void setEducationLevelCode(Integer educationLevelCode) {
    ...
    public Integer getLifeTimeZoneCode() {
        return lifeTimeZoneCode;
    }

    public void setLifeTimeZoneCode(Integer lifeTimeZoneCode) {
        this.lifeTimeZoneCode = lifeTimeZoneCode;
    }

    public Integer getLifeTimeVillageCode() {
        return lifeTimeVillageCode;
    }

    public void setLifeTimeVillageCode(Integer lifeTimeVillageCode) {
        this.lifeTimeVillageCode = lifeTimeVillageCode;
    }

    public Integer getLifeTimeAddrTypeCode() {
        return lifeTimeAddrTypeCode;
    }

    public void setLifeTimeAddrTypeCode(Integer lifeTimeAddrTypeCode) {
        this.lifeTimeAddrTypeCode = lifeTimeAddrTypeCode;
    }

    public Integer getRegisterVillageCode() {
        return registerVillageCode;
    }

    public void setRegisterVillageCode(Integer registerVillageCode) {
        this.registerVillageCode = registerVillageCode;
    }

    public Integer getDeathPlaceCode() {
        return deathPlaceCode;
    }

    public void setDeathPlaceCode(Integer deathPlaceCode) {
        this.deathPlaceCode = deathPlaceCode;
    }

    public Integer getDiagnosisTypeCode() {
        return diagnosisTypeCode;
    }

    public void setDiagnosisTypeCode(Integer diagnosisTypeCode) {
