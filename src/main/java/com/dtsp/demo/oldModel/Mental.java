...
public class Mental {
    ...
    private String gzdw;
    private String xxgys;
    private String xzd;
    private Date fb_date;
    private String ccmd_id;
    private String zddw;
    ...
    public String getXxgys() {
        return xxgys;
    }

    public void setXxgys(String xxgys) {
        this.xxgys = xxgys;
    }
    ...
    public String getCcmd_id() {
        return ccmd_id;
    }

    public void setCcmd_id(String ccmd_id) {
