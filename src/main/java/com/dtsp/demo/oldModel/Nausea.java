...
public class Nausea {
    ...
    private String zd;
    private String bllx;
    private String qzsqb;
    private String disease_id;
    private String lcfq;
    private String vicdo3;
    private String fhcd;
    private String xhbz;
    private String zddw;
    ...
    public String getQzsqb() {
        return qzsqb;
    }

    public void setQzsqb(String qzsqb) {
        this.qzsqb = qzsqb;
    }
    ...
    public String getVicdo3() {
        return vicdo3;
    }

    public void setVicdo3(String vicdo3) {
        this.vicdo3 = vicdo3;
    }
